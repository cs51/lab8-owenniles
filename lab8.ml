...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    evt := List.filter (fun l -> not (l.id = i)) !evt
...
let fnn : id = add_listener newswire fakeNewsNetwork
let bf : id = add_listener newswire buzzFake
...
let receive_report (h : string) : unit =
  let _ = add_listener publish (fun () -> fakeNewsNetwork h ; buzzFake h) in
  ()
...
let pub : id = add_listener newswire receive_report
